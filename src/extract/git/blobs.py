...
This module provides both low-level git blob access (via pygit2) and high-level
repo blob extraction with caching and materialization support.
"""
...
from extract.infrastructure.schema_cache import repo_file_blobs_fingerprint
...
# --------------------------------------------------------------------------- #
# Low-level Git Blob Access (from repo_blobs_git.py)
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# High-level Repo Blob Extraction (from repo_blobs.py)
# --------------------------------------------------------------------------- #
