...
_EXPORT_MAP: dict[str, tuple[str, str]] = {
    ...
    "AmbiguityPolicy": ("normalize.rule_model", "AmbiguityPolicy"),
    "ConfidencePolicy": ("normalize.rule_model", "ConfidencePolicy"),
    "DiagnosticsSources": ("normalize.ibis_api", "DiagnosticsSources"),
    "EvidenceSpec": ("normalize.rule_model", "EvidenceSpec"),
    "ExecutionMode": ("normalize.rule_model", "ExecutionMode"),
    ...
    "NormalizeRule": ("normalize.rule_model", "NormalizeRule"),
