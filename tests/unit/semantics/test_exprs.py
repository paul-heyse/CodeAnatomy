...
class TestExprContextImpl:
    ...
    def test_col_returns_expression(self) -> None:
    ...
    def test_lit_returns_expression(self) -> None:
...
class TestClamp:
    ...
    def test_clamp_expression_structure(self) -> None:
    ...
    def test_clamp_in_dataframe(self) -> None:
...
class TestDslHelpers:
    ...
    def test_c_column_reference(self) -> None:
    ...
    def test_v_literal_value(self) -> None:
    ...
    def test_v_string_literal(self) -> None:
    ...
    def test_eq_equality(self) -> None:
    ...
    def test_eq_value_equality(self) -> None:
    ...
    def test_gt_greater_than(self) -> None:
    ...
    def test_lt_less_than(self) -> None:
    ...
    def test_gte_greater_equal(self) -> None:
    ...
    def test_lte_less_equal(self) -> None:
...
class TestLogicalOperators:
    ...
    def test_and_empty_returns_true(self) -> None:
    ...
    def test_or_empty_returns_false(self) -> None:
...
class TestSpanPredicates:
    ...
    def test_between_overlap(self) -> None:
    ...
    def test_span_contains_span(self) -> None:
...
class TestCaseExpressions:
    ...
    def test_case_eq_matches(self) -> None:
    ...
    def test_case_eq_value_matches(self) -> None:
...
class TestArithmeticExpressions:
    ...
    def test_add_columns_empty_returns_zero(self) -> None:
...
class TestCoalesceDefault:
    ...
    def test_coalesce_default_fills_nulls(self) -> None:
...
class TestAlias:
    ...
    def test_alias_renames_expression(self) -> None:
...
class TestSortExpr:
    ...
    def test_sort_expr_ascending(self) -> None:
    ...
    def test_sort_expr_descending(self) -> None:
    ...
    def test_sort_expr_default_ascending(self) -> None:
...
class TestStableHash64:
    ...
    def test_stable_hash64_expression(self) -> None:
...
class TestExprValidation:
    ...
    def test_validate_expr_spec_allows_known_columns(self) -> None:
    ...
    def test_validate_expr_spec_rejects_unknown_columns(self) -> None:
