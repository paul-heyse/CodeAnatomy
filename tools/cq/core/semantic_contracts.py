...
These types define the contract boundary for semantic enrichment state,
moved from ``tools.cq.search.semantic.models`` to fix dependency inversion
(core should not import from search).
"""
