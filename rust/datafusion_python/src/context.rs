...
use crate::errors::{py_datafusion_err, py_value_err, PyDataFusionError, PyDataFusionResult};
...
impl PySessionContext {
    ...
    #[allow(deprecated)]
    #[deprecated(
        note = "Use register_table(name, provider) for session-aware provider registration."
    )]
