...
def test_runtime_execution_policy_parses_extended_cache_settings(
    ...
    monkeypatch.setenv("CQ_RUNTIME_CACHE_SIZE_LIMIT_BYTES", "2048")
    ...
    monkeypatch.setenv("CQ_RUNTIME_CACHE_TTL_SEARCH_CANDIDATES_SECONDS", "21")
    ...
    assert policy.cache.size_limit_bytes == 2048
    ...
    assert policy.cache.namespace_ttl_seconds["search_candidates"] == 21
