...
_EXPORT_MAP: dict[str, tuple[str, str]] = {
    ...
    "ValidationPolicySpec": ("schema_spec.system", "ValidationPolicySpec"),
    "ContractCatalogSpec": ("schema_spec.system", "ContractCatalogSpec"),
    "ContractSpec": ("schema_spec.system", "ContractSpec"),
    "DatasetKind": ("schema_spec.system", "DatasetKind"),
    ...
    "dataset_spec_contract": ("schema_spec.system", "dataset_spec_contract"),
    "dataset_spec_contract_spec_or_default": (
        "schema_spec.system",
        "dataset_spec_contract_spec_or_default",
    ),
    "dataset_spec_datafusion_scan": ("schema_spec.system", "dataset_spec_datafusion_scan"),
    "dataset_spec_delta_cdf_policy": ("schema_spec.system", "dataset_spec_delta_cdf_policy"),
    "dataset_spec_delta_constraints": ("schema_spec.system", "dataset_spec_delta_constraints"),
    "dataset_spec_delta_feature_gate": ("schema_spec.system", "dataset_spec_delta_feature_gate"),
    "dataset_spec_delta_maintenance_policy": (
        "schema_spec.system",
        "dataset_spec_delta_maintenance_policy",
    ),
    "dataset_spec_delta_scan": ("schema_spec.system", "dataset_spec_delta_scan"),
    "dataset_spec_delta_schema_policy": ("schema_spec.system", "dataset_spec_delta_schema_policy"),
    "dataset_spec_delta_write_policy": ("schema_spec.system", "dataset_spec_delta_write_policy"),
    "dataset_spec_encoding_policy": ("schema_spec.system", "dataset_spec_encoding_policy"),
    "dataset_spec_name": ("schema_spec.system", "dataset_spec_name"),
    "dataset_spec_ordering": ("schema_spec.system", "dataset_spec_ordering"),
    "dataset_spec_query": ("schema_spec.system", "dataset_spec_query"),
    "dataset_spec_resolved_view_specs": ("schema_spec.system", "dataset_spec_resolved_view_specs"),
    "dataset_spec_schema": ("schema_spec.system", "dataset_spec_schema"),
    "dataset_spec_strict_schema_validation": (
        "schema_spec.system",
        "dataset_spec_strict_schema_validation",
    ),
