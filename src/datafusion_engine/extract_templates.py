    ...
    return (
        ...
        },
        {
            **base,
            ...
            "ordering_keys": [
                {"column": "path", "order": "ascending"},
                {"column": "start_line", "order": "ascending"},
                {"column": "start_char", "order": "ascending"},
            ],
            "join_keys": [
                "document_id",
                "symbol",
        ...
        {
            **base,
            "name": "scip_symbol_information_v1",
            "bundles": None,
            "fields": [
                "symbol",
                "display_name",
            ...
            "row_fields": None,
            "row_extras": None,
            "ordering_keys": [{"column": "symbol", "order": "ascending"}],
            "join_keys": ["symbol"],
            "enabled_when": None,
            "feature_flag": None,
            "postprocess": None,
        ...
        },
        {
            **base,
            ...
            "ordering_keys": [
                {"column": "path", "order": "ascending"},
                {"column": "symbol", "order": "ascending"},
            ],
            "join_keys": ["document_id", "symbol"],
            "enabled_when": None,
            "feature_flag": None,
            "postprocess": None,
            "metadata_extra": None,
        ...
        {
            **base,
            "name": "scip_external_symbol_information_v1",
            "bundles": None,
            "fields": [
                "symbol",
                "display_name",
        ...
        },
        {
            **base,
            ...
            "ordering_keys": [
                {"column": "symbol", "order": "ascending"},
                {"column": "related_symbol", "order": "ascending"},
            ],
        ...
        {
            **base,
            "name": "scip_signature_occurrences_v1",
            "bundles": ["scip_range_len"],
            "fields": [
                "parent_symbol",
                "symbol",
                "symbol_roles",
            ...
            "row_extras": None,
            "ordering_keys": [
                {"column": "parent_symbol", "order": "ascending"},
                {"column": "start_line", "order": "ascending"},
                {"column": "start_char", "order": "ascending"},
            ],
            "join_keys": [
