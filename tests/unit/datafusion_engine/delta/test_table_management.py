"""Tests for table-management delegation entrypoints."""
...
def test_provider_bundle_delegates(monkeypatch: pytest.MonkeyPatch) -> None:
    """Provider bundle delegates to canonical control-plane helper."""
    monkeypatch.setattr(
...
def test_snapshot_info_delegates(monkeypatch: pytest.MonkeyPatch) -> None:
    """Snapshot info delegates to canonical control-plane helper."""
