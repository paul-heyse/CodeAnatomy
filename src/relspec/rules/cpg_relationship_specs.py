...
def _base_definition_specs() -> tuple[RuleDefinitionSpec, ...]:
    return (
        ...
        RuleDefinitionSpec(
            name="symtable_scope_parent_edges",
            ...
            edge=EdgeDefinitionSpec(
                ...
                origin="symtable",
                resolution_method="SCOPE_PARENT",
                option_flag="emit_symtable_scope_edges",
                path_cols=("path",),
            ),
        ),
        RuleDefinitionSpec(
            name="symtable_scope_binds_edges",
            kind=RuleKind.FILTER_PROJECT,
            ...
            edge=EdgeDefinitionSpec(
                ...
                dst_cols=("binding_id",),
                origin="symtable",
                resolution_method="SCOPE_BINDS",
                option_flag="emit_symtable_binding_edges",
                path_cols=("path",),
            ),
        ),
        RuleDefinitionSpec(
            name="symtable_binding_resolves_to",
            kind=RuleKind.FILTER_PROJECT,
            inputs=("symtable_binding_resolutions",),
            project=ProjectConfig(
                select=(
                    "binding_id",
                    "outer_binding_id",
            ...
            edge=EdgeDefinitionSpec(
                ...
                origin="symtable",
                resolution_method="BINDING_RESOLVE",
                option_flag="emit_symtable_binding_edges",
                path_cols=("path",),
            ),
        ),
        RuleDefinitionSpec(
            name="symtable_def_site_edges",
            kind=RuleKind.FILTER_PROJECT,
            inputs=("symtable_def_sites",),
            project=ProjectConfig(
                select=(
                    "def_site_id",
                    "binding_id",
            ...
            edge=EdgeDefinitionSpec(
                ...
                dst_cols=("binding_id",),
                origin="symtable",
                resolution_method="DEF_SITE",
                option_flag="emit_symtable_def_use_edges",
                path_cols=("path",),
                bstart_cols=("bstart",),
                bend_cols=("bend",),
            ),
        ...
        RuleDefinitionSpec(
            name="symtable_use_site_edges",
            kind=RuleKind.FILTER_PROJECT,
            inputs=("symtable_use_sites",),
            project=ProjectConfig(
                select=(
                    "use_site_id",
                    "binding_id",
        ...
        RuleDefinitionSpec(
            ...
            edge=EdgeDefinitionSpec(
                ...
                origin="symtable",
                resolution_method="TYPE_PARAM_OF",
                option_flag="emit_symtable_type_param_edges",
                path_cols=("path",),
            ),
        ),
    )
