...
class TestExtractionSchemaBuilder:
    ...
    def test_builder_with_field_spec(self) -> None:
        ...
        custom_spec = FieldSpec(name="custom_field", dtype=pa.float64())
    ...
    def test_builder_with_custom_bundle(self) -> None:
        ...
        bundle = FieldBundle(
            name="custom_bundle",
            fields=(
                FieldSpec(name="bundle_field1", dtype=pa.string()),
                FieldSpec(name="bundle_field2", dtype=pa.int64()),
            ),
        )
...
class TestExtractionSchemaTemplates:
    ...
    def test_build_template_with_extra_fields(self) -> None:
        ...
        extra = [FieldSpec(name="extra_col", dtype=pa.binary())]
