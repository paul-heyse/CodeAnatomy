...
adds a dedicated PR for **Ibis ⇄ SQLGlot ⇄ DataFusion expression coverage and
execution fallbacks** so the adapter bridge becomes complete and durable.
...
**PR-05 — Expression Coverage + SQL Fallback for DataFusion execution**
