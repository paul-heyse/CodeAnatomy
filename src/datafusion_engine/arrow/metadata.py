...
from datafusion_engine.arrow.encoding import EncodingPolicy, EncodingSpec
from datafusion_engine.arrow.encoding_metadata import (
    DICT_INDEX_META,
    DICT_ORDERED_META,
    ENCODING_DICTIONARY,
    ENCODING_META,
...
from datafusion_engine.arrow.types import (
    ListTypeProtocol,
    MapTypeProtocol,
    StructTypeProtocol,
)
...
if TYPE_CHECKING:
    ...
    from datafusion_engine.schema.spec_protocol import TableSchemaSpec as TableSchemaProtocol
