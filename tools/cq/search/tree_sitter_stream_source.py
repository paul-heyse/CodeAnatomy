"""Streaming source callback helpers for large tree-sitter parses."""
...
def build_stream_reader(
    ...
    *,
    ...
    Returns:
        Callable[[int, tuple[int, int]], bytes]: Reader callback for parser input.
    """
...
def parse_streaming_source(
    ...
    *,
    ...
    Returns:
        Tree | None: Parsed tree when parsing succeeds.
    """
