...
NODE_KIND_CST_CALL_ARG = NodeKindId("CST_CALL_ARG")
NODE_KIND_CST_DOCSTRING = NodeKindId("CST_DOCSTRING")
NODE_KIND_CST_DECORATOR = NodeKindId("CST_DECORATOR")
...
__all__ = [
    ...
    "NODE_KIND_CST_CALL_ARG",
    "NODE_KIND_CST_DECORATOR",
    "NODE_KIND_CST_DEF",
    "NODE_KIND_CST_DOCSTRING",
