...
from semantics.diagnostics import dataframe_row_count, semantic_diagnostic_view_builders
...
if TYPE_CHECKING:
    ...
    from semantics.registry import SemanticModel, SemanticNormalizationSpec, SemanticSpecIndex
