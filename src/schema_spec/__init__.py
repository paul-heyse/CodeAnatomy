...
_EXPORT_MAP: dict[str, tuple[str, str]] = {
    ...
    "SCHEMA_EVOLUTION_PRESETS": ("schema_spec.contracts", "SCHEMA_EVOLUTION_PRESETS"),
    ...
    "ArrowValidationOptions": ("schema_spec.contracts", "ArrowValidationOptions"),
    "ValidationPolicySpec": ("schema_spec.contracts", "ValidationPolicySpec"),
    "ContractCatalogSpec": ("schema_spec.contracts", "ContractCatalogSpec"),
    "ContractSpec": ("schema_spec.contracts", "ContractSpec"),
    "DatasetKind": ("schema_spec.contracts", "DatasetKind"),
    "DatasetOpenSpec": ("schema_spec.contracts", "DatasetOpenSpec"),
    "DatasetSpec": ("schema_spec.contracts", "DatasetSpec"),
    "DedupeSpecSpec": ("schema_spec.contracts", "DedupeSpecSpec"),
    "DeltaScanOptions": ("schema_spec.contracts", "DeltaScanOptions"),
    "DeltaSchemaPolicy": ("schema_spec.contracts", "DeltaSchemaPolicy"),
    "DeltaWritePolicy": ("schema_spec.contracts", "DeltaWritePolicy"),
    ...
    "SortKeySpec": ("schema_spec.contracts", "SortKeySpec"),
    "TableSchemaSpec": ("schema_spec.specs", "TableSchemaSpec"),
    "TableSpecConstraints": ("schema_spec.contracts", "TableSpecConstraints"),
    "VirtualFieldSpec": ("schema_spec.contracts", "VirtualFieldSpec"),
    ...
    "dataset_spec_from_contract": ("schema_spec.contracts", "dataset_spec_from_contract"),
    "dataset_spec_from_dataset": ("schema_spec.contracts", "dataset_spec_from_dataset"),
    "dataset_spec_from_path": ("schema_spec.contracts", "dataset_spec_from_path"),
    "dataset_spec_from_schema": ("schema_spec.contracts", "dataset_spec_from_schema"),
    "dataset_spec_contract": ("schema_spec.contracts", "dataset_spec_contract"),
    "dataset_spec_contract_spec_or_default": (
        "schema_spec.contracts",
        "dataset_spec_contract_spec_or_default",
    ),
    "dataset_spec_datafusion_scan": ("schema_spec.contracts", "dataset_spec_datafusion_scan"),
    "dataset_spec_delta_cdf_policy": ("schema_spec.contracts", "dataset_spec_delta_cdf_policy"),
    "dataset_spec_delta_constraints": ("schema_spec.contracts", "dataset_spec_delta_constraints"),
    "dataset_spec_delta_feature_gate": ("schema_spec.contracts", "dataset_spec_delta_feature_gate"),
    "dataset_spec_delta_maintenance_policy": (
        "schema_spec.contracts",
        "dataset_spec_delta_maintenance_policy",
    ),
    "dataset_spec_delta_scan": ("schema_spec.contracts", "dataset_spec_delta_scan"),
    "dataset_spec_delta_schema_policy": (
        "schema_spec.contracts",
        "dataset_spec_delta_schema_policy",
    ),
    "dataset_spec_delta_write_policy": ("schema_spec.contracts", "dataset_spec_delta_write_policy"),
    "dataset_spec_encoding_policy": ("schema_spec.contracts", "dataset_spec_encoding_policy"),
    "dataset_spec_name": ("schema_spec.contracts", "dataset_spec_name"),
    "dataset_spec_ordering": ("schema_spec.contracts", "dataset_spec_ordering"),
    "dataset_spec_query": ("schema_spec.contracts", "dataset_spec_query"),
    "dataset_spec_resolved_view_specs": (
        "schema_spec.contracts",
        "dataset_spec_resolved_view_specs",
    ),
    "dataset_spec_schema": ("schema_spec.contracts", "dataset_spec_schema"),
    "dataset_spec_strict_schema_validation": (
        "schema_spec.contracts",
        "dataset_spec_strict_schema_validation",
    ),
    ...
    "dataset_table_column_defaults": ("schema_spec.contracts", "dataset_table_column_defaults"),
    "dataset_table_constraints": ("schema_spec.contracts", "dataset_table_constraints"),
    "dataset_table_definition": ("schema_spec.contracts", "dataset_table_definition"),
    "dataset_table_ddl_fingerprint": ("schema_spec.contracts", "dataset_table_ddl_fingerprint"),
    "dataset_table_logical_plan": ("schema_spec.contracts", "dataset_table_logical_plan"),
    "ddl_fingerprint_from_definition": ("schema_spec.contracts", "ddl_fingerprint_from_definition"),
    ...
    "make_contract_spec": ("schema_spec.contracts", "make_contract_spec"),
    "make_dataset_spec": ("schema_spec.contracts", "make_dataset_spec"),
    "make_table_spec": ("schema_spec.contracts", "make_table_spec"),
    "resolve_schema_evolution_spec": ("schema_spec.contracts", "resolve_schema_evolution_spec"),
    ...
    "TableSchemaContract": ("schema_spec.contracts", "TableSchemaContract"),
    "validate_arrow_table": ("schema_spec.contracts", "validate_arrow_table"),
}
