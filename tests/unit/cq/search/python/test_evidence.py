...
class TestEvaluatePythonSemanticSignal:
    ...
    @staticmethod
    def test_no_signal_when_all_missing() -> None:
    ...
    @staticmethod
    def test_has_signal_with_grounding_and_call_graph() -> None:
...
class TestBuildAgreementSummary:
    ...
    @staticmethod
    def test_conflict_when_no_matches() -> None:
