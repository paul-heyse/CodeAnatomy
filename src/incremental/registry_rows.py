...
DATASET_ROWS: tuple[DatasetRow, ...] = (
    ...
    DatasetRow(
        name="datafusion_plan_artifacts_v6",
        version=SCHEMA_VERSION,
        fields=(
            ...
            ArrowFieldSpec(name="planning_env_json", dtype=interop.string()),
            ArrowFieldSpec(name="planning_env_hash", dtype=interop.string()),
            ArrowFieldSpec(name="rulepack_json", dtype=interop.string()),
            ArrowFieldSpec(name="rulepack_hash", dtype=interop.string()),
            ArrowFieldSpec(name="information_schema_json", dtype=interop.string()),
            ArrowFieldSpec(name="information_schema_hash", dtype=interop.string()),
            ArrowFieldSpec(name="substrait_b64", dtype=interop.string()),
            ArrowFieldSpec(name="logical_plan_proto_b64", dtype=interop.string()),
            ArrowFieldSpec(name="optimized_plan_proto_b64", dtype=interop.string()),
            ArrowFieldSpec(name="execution_plan_proto_b64", dtype=interop.string()),
            ArrowFieldSpec(name="explain_tree_rows_json", dtype=interop.string()),
            ArrowFieldSpec(name="explain_verbose_rows_json", dtype=interop.string()),
            ...
            ArrowFieldSpec(name="substrait_validation_json", dtype=interop.string()),
            ...
            ArrowFieldSpec(name="udf_planner_snapshot_json", dtype=interop.string()),
        ...
        constraints=TableSpecConstraints(
            required_non_null=(
                ...
                "required_udfs_json",
                "required_rewrite_tags_json",
                "domain_planner_names_json",
                "delta_inputs_json",
                "df_settings_json",
                "planning_env_json",
                "planning_env_hash",
                ...
                "scan_keys_json",
                "plan_details_json",
                "function_registry_snapshot_json",
                "udf_snapshot_json",
                "udf_compatibility_ok",
                "udf_compatibility_detail_json",
            ),
