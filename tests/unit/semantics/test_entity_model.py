...
class TestTableSpecParity:
    ...
    def test_table_spec_structural_identity(source_table: str) -> None:
    ...
    @staticmethod
    def test_generate_table_specs_round_trip() -> None:
...
class TestNormalizationSpecParity:
    ...
    def test_normalization_spec_structural_identity(index: int) -> None:
    ...
    @staticmethod
    def test_generate_normalization_specs_round_trip() -> None:
    ...
    @staticmethod
    def test_normalization_spec_order_matches() -> None:
...
class TestForeignKeyEntities:
    ...
    @staticmethod
    def test_cst_defs_has_container_fk() -> None:
    ...
    @staticmethod
    def test_cst_call_args_has_call_fk() -> None:
    ...
    @staticmethod
    def test_cst_docstrings_has_owner_fk() -> None:
    ...
    @staticmethod
    def test_cst_decorators_has_owner_fk() -> None:
    ...
    @staticmethod
    def test_entities_without_fks() -> None:
...
class TestContentColumns:
    ...
    def test_entity_with_content(source_table: str, expected_content: tuple[str, ...]) -> None:
    ...
    @staticmethod
    def test_entities_without_content() -> None:
...
class TestNonDefaultSpanColumns:
    ...
    @staticmethod
    def test_cst_defs_uses_def_span() -> None:
    ...
    @staticmethod
    def test_cst_imports_uses_alias_span() -> None:
    ...
    @staticmethod
    def test_cst_callsites_uses_call_span() -> None:
...
class TestNormalizedNameOverride:
    ...
    @staticmethod
    def test_cst_callsites_uses_override() -> None:
...
class TestEntityDeclarationDefaults:
    ...
    @staticmethod
    def test_span_unit_defaults_to_byte() -> None:
    ...
    @staticmethod
    def test_include_in_cpg_nodes_defaults_to_true() -> None:
...
class TestEntityModelStructs:
    ...
    @staticmethod
    def test_identity_spec_fields() -> None:
    ...
    @staticmethod
    def test_location_spec_fields() -> None:
    ...
    @staticmethod
    def test_foreign_key_spec_defaults() -> None:
    ...
    @staticmethod
    def test_entity_declaration_minimal() -> None:
