"""Metadata contracts for relspec relationship outputs."""
...
def rel_name_symbol_metadata_spec() -> SchemaMetadataSpec:
    ...
    -------
    SchemaMetadataSpec
        Metadata spec for the rel-name-symbol output.
    """
...
def rel_import_symbol_metadata_spec() -> SchemaMetadataSpec:
    ...
    -------
    SchemaMetadataSpec
        Metadata spec for the rel-import-symbol output.
    """
...
def rel_def_symbol_metadata_spec() -> SchemaMetadataSpec:
    ...
    -------
    SchemaMetadataSpec
        Metadata spec for the rel-def-symbol output.
    """
...
def rel_callsite_symbol_metadata_spec() -> SchemaMetadataSpec:
    ...
    -------
    SchemaMetadataSpec
        Metadata spec for the rel-callsite-symbol output.
    """
...
def relation_output_metadata_spec() -> SchemaMetadataSpec:
    ...
    -------
    SchemaMetadataSpec
        Metadata spec for canonical relation output rows.
    """
...
def relspec_metadata_spec(name: str) -> SchemaMetadataSpec:
    """Return metadata spec for a relspec output view.

    Returns:
    -------
    SchemaMetadataSpec
        Resolved metadata spec for the requested relspec output.

    Raises:
        KeyError: If the requested output name is unknown.
    """
