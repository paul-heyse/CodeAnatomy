...
@lru_cache
def _functions() -> ModuleType:
    return import_module("datafusion.functions")
...
class Expr:
    ...
    def list_distinct(self) -> Expr:
        ...
        """
        funcs = _functions()
        return funcs.list_distinct(self)

    def iszero(self) -> Expr:
        """Returns true if a given number is +0.0 or -0.0 otherwise returns false."""
        funcs = _functions()
        return funcs.iszero(self)

    def array_distinct(self) -> Expr:
        """Returns distinct values from the array after removing duplicates."""
        funcs = _functions()
        return funcs.array_distinct(self)

    def arrow_typeof(self) -> Expr:
        """Returns the Arrow type of the expression."""
        funcs = _functions()
        return funcs.arrow_typeof(self)

    def length(self) -> Expr:
        """The number of characters in the ``string``."""
        funcs = _functions()
        return funcs.length(self)

    def lower(self) -> Expr:
        """Converts a string to lowercase."""
        funcs = _functions()
        return funcs.lower(self)
    ...
    def acos(self) -> Expr:
        ...
        """
        funcs = _functions()
        return funcs.acos(self)

    def ascii(self) -> Expr:
        """Returns the numeric code of the first character of the argument."""
        funcs = _functions()
        return funcs.ascii(self)

    def sha384(self) -> Expr:
        """Computes the SHA-384 hash of a binary string."""
        funcs = _functions()
        return funcs.sha384(self)

    def isnan(self) -> Expr:
        """Returns true if a given number is +NaN or -NaN otherwise returns false."""
        funcs = _functions()
        return funcs.isnan(self)

    def degrees(self) -> Expr:
        """Converts the argument from radians to degrees."""
        funcs = _functions()
        return funcs.degrees(self)

    def cardinality(self) -> Expr:
        """Returns the total number of elements in the array."""
        funcs = _functions()
        return funcs.cardinality(self)

    def sha224(self) -> Expr:
        """Computes the SHA-224 hash of a binary string."""
        funcs = _functions()
        return funcs.sha224(self)

    def asinh(self) -> Expr:
        """Returns inverse hyperbolic sine."""
        funcs = _functions()
        return funcs.asinh(self)

    def flatten(self) -> Expr:
        """Flattens an array of arrays into a single array."""
        funcs = _functions()
        return funcs.flatten(self)

    def exp(self) -> Expr:
        """Returns the exponential of the argument."""
        funcs = _functions()
        return funcs.exp(self)
    ...
    def btrim(self) -> Expr:
        ...
        funcs = _functions()
        return funcs.btrim(self)

    def md5(self) -> Expr:
        """Computes an MD5 128-bit checksum for a string expression."""
        funcs = _functions()
        return funcs.md5(self)

    def octet_length(self) -> Expr:
        """Returns the number of bytes of a string."""
        funcs = _functions()
        return funcs.octet_length(self)

    def cosh(self) -> Expr:
        """Returns the hyperbolic cosine of the argument."""
        funcs = _functions()
        return funcs.cosh(self)

    def radians(self) -> Expr:
        """Converts the argument from degrees to radians."""
        funcs = _functions()
        return funcs.radians(self)

    def sqrt(self) -> Expr:
        """Returns the square root of the argument."""
        funcs = _functions()
        return funcs.sqrt(self)

    def character_length(self) -> Expr:
        """Returns the number of characters in the argument."""
        funcs = _functions()
        return funcs.character_length(self)

    def tanh(self) -> Expr:
        """Returns the hyperbolic tangent of the argument."""
        funcs = _functions()
        return funcs.tanh(self)

    def atan(self) -> Expr:
        """Returns inverse tangent of a number."""
        funcs = _functions()
        return funcs.atan(self)

    def rtrim(self) -> Expr:
        """Removes all characters, spaces by default, from the end of a string."""
        funcs = _functions()
        return funcs.rtrim(self)

    def atanh(self) -> Expr:
        """Returns inverse hyperbolic tangent."""
        funcs = _functions()
        return funcs.atanh(self)
    ...
    def list_dims(self) -> Expr:
        ...
        """
        funcs = _functions()
        return funcs.list_dims(self)

    def sha256(self) -> Expr:
        """Computes the SHA-256 hash of a binary string."""
        funcs = _functions()
        return funcs.sha256(self)

    def factorial(self) -> Expr:
        """Returns the factorial of the argument."""
        funcs = _functions()
        return funcs.factorial(self)

    def acosh(self) -> Expr:
        """Returns inverse hyperbolic cosine."""
        funcs = _functions()
        return funcs.acosh(self)

    def floor(self) -> Expr:
        """Returns the nearest integer less than or equal to the argument."""
        funcs = _functions()
        return funcs.floor(self)

    def ceil(self) -> Expr:
        """Returns the nearest integer greater than or equal to argument."""
        funcs = _functions()
        return funcs.ceil(self)
    ...
    def list_length(self) -> Expr:
        ...
        """
        funcs = _functions()
        return funcs.list_length(self)

    def upper(self) -> Expr:
        """Converts a string to uppercase."""
        funcs = _functions()
        return funcs.upper(self)

    def chr(self) -> Expr:
        """Converts the Unicode code point to a UTF8 character."""
        funcs = _functions()
        return funcs.chr(self)

    def ln(self) -> Expr:
        """Returns the natural logarithm (base e) of the argument."""
        funcs = _functions()
        return funcs.ln(self)

    def tan(self) -> Expr:
        """Returns the tangent of the argument."""
        funcs = _functions()
        return funcs.tan(self)

    def array_pop_front(self) -> Expr:
        """Returns the array without the first element."""
        funcs = _functions()
        return funcs.array_pop_front(self)

    def cbrt(self) -> Expr:
        """Returns the cube root of a number."""
        funcs = _functions()
        return funcs.cbrt(self)

    def sha512(self) -> Expr:
        """Computes the SHA-512 hash of a binary string."""
        funcs = _functions()
        return funcs.sha512(self)

    def char_length(self) -> Expr:
        """The number of characters in the ``string``."""
        funcs = _functions()
        return funcs.char_length(self)
    ...
    def list_ndims(self) -> Expr:
        ...
        """
        funcs = _functions()
        return funcs.list_ndims(self)

    def trim(self) -> Expr:
        """Removes all characters, spaces by default, from both sides of a string."""
        funcs = _functions()
        return funcs.trim(self)

    def cos(self) -> Expr:
        """Returns the cosine of the argument."""
        funcs = _functions()
        return funcs.cos(self)

    def sinh(self) -> Expr:
        """Returns the hyperbolic sine of the argument."""
        funcs = _functions()
        return funcs.sinh(self)

    def empty(self) -> Expr:
        """This is an alias for :py:func:`array_empty`."""
        funcs = _functions()
        return funcs.empty(self)

    def ltrim(self) -> Expr:
        """Removes all characters, spaces by default, from the beginning of a string."""
        funcs = _functions()
        return funcs.ltrim(self)

    def signum(self) -> Expr:
        """Returns the sign of the argument (-1, 0, +1)."""
        funcs = _functions()
        return funcs.signum(self)

    def log2(self) -> Expr:
        """Base 2 logarithm of the argument."""
        funcs = _functions()
        return funcs.log2(self)

    def cot(self) -> Expr:
        """Returns the cotangent of the argument."""
        funcs = _functions()
        return funcs.cot(self)
...
class WindowFrame:
    ...
    def __init__(
        ...
        if not isinstance(start_bound, pa.Scalar) and start_bound is not None:
            start_bound = cast("pa.Scalar", pa.scalar(start_bound))
        if start_bound is not None and units in ("rows", "groups"):
            start_bound = start_bound.cast(pa.uint64())
        if not isinstance(end_bound, pa.Scalar) and end_bound is not None:
            end_bound = cast("pa.Scalar", pa.scalar(end_bound))
        if end_bound is not None and units in ("rows", "groups"):
