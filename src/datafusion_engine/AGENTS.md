...
**Use the `datafusion-stack` skill** before touching DataFusion/Delta/UDF APIs:

```
/datafusion-stack
```

This skill provides version-correct API references. Do not guess DataFusion APIs.
...
- Skill reference: `.claude/skills/datafusion-stack/`
