...
class Table:
    ...
    @staticmethod
    def from_pylist(data: Sequence[Mapping[str, object]], schema: Schema | None = None) -> Table: ...
    @staticmethod
    def from_arrays(
...
def scalar(value: object, *, type: DataType | None = None) -> Scalar: ...
...
class StructArray(Array):
    @staticmethod
    def from_arrays(arrays: Sequence[Array | ChunkedArray], *, names: Sequence[str]) -> StructArray: ...
