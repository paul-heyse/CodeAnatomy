"""Shared runtime orchestration for fragment cache probe/persist cycles."""
...
def run_fragment_scan[T](
    *,
    ...
    Returns:
        FragmentScanResult[T]: Probe hits/misses and optional miss payload.
    """
...
def probe_or_persist_fragment(
    *,
    ...
    """Load a bytes fragment from cache or compute-and-persist it.

    Returns:
        bytes: Cached or newly-computed fragment payload.
    """
