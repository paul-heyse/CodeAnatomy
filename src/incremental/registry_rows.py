...
DATASET_ROWS: tuple[DatasetRow, ...] = (
    ...
    DatasetRow(
        name="datafusion_plan_artifacts_v4",
        version=SCHEMA_VERSION,
        fields=(
            ...
            ArrowFieldSpec(name="explain_tree_json", dtype=interop.string()),
            ArrowFieldSpec(name="explain_verbose_json", dtype=interop.string()),
