...
# Module: operations::drop_constraints

## Contents

**Structs**

- [`DropConstraintBuilder`](#dropconstraintbuilder) - Remove constraints from the table
...
- `fn with_constraint<S>(self: Self, name: S) -> Self` - Specify the constraint to be removed
- `fn with_raise_if_not_exists(self: Self, raise: bool) -> Self` - Specify if you want to raise if the constraint does not exist
